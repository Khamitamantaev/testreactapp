...
export default function UpdateDebitModal(props: any) {
    ...
    const CURRENT_VALUE = wallet.getCreditByID(parseInt(DEBIT_ID))!
    ...
    const updateCredit = () => {
        wallet.updateCredit(values)
         setOpen(false)
    }

    return (
        <div>
            <Button onClick={handleOpenClick}>Update Credit</Button>
            <Modal
                open={open}
            ...
            >
                <Box sx={style}>
                    <Grid container spacing={2} columns={{}}>
                        ...
                        <Grid item xs={6}>
                            <Button onClick={updateCredit} variant="contained" color="primary">
                                Обновить
                            </Button>
